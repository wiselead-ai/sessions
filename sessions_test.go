...
type mockDB struct {
	execFn func(ctx context.Context, query string, args ...interface{}) (sqldb.ExecResult, error)
}

func (m *mockDB) Exec(ctx context.Context, query string, args ...interface{}) (sqldb.ExecResult, error) {
